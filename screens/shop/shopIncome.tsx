...
const shopIncome = () => {
  ...
  const saveData = async (data) => {
    await AsyncStorage.setItem('shopDataIncome', JSON.stringify(data));
  };

  const loadData = async () => {
    const storedData = await AsyncStorage.getItem('shopDataIncome');
  ...
  return (
    <View style={styles.container}>
      <Text>Total Shop Income: ₹{totalCost}</Text>
