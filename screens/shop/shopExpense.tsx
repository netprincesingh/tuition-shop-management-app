...
const shopExpense = () => {
  ...
  const saveData = async (data) => {
    await AsyncStorage.setItem('shopDataExpense', JSON.stringify(data));
  };

  const loadData = async () => {
    const storedData = await AsyncStorage.getItem('shopDataExpense');
  ...
  return (
    <View style={styles.container}>
      <Text>Total Shop Expense: ₹{totalCost}</Text>
